...
reference_h5ad_path = "/orange/kejun.huang/vasco.hinostroza/data/ibd/reference.h5ad"
cosmx_h5ad_path = "/orange/kejun.huang/vasco.hinostroza/data/ibd/cosmx.h5ad"
ref_model_dir = "/blue/kejun.huang/vasco.hinostroza/nicherunner/runs/ibd_cosmx_k4/ref_model"
os.makedirs(ref_model_dir, exist_ok=True) # Ensure the directory exists
ref_model_path = os.path.join(ref_model_dir, "cell2location_reference_model_k4")
...
output_dir = "/blue/kejun.huang/vasco.hinostroza/nicherunner/runs/ibd_cosmx_k4/output"
...
inf_aver_csv_path = os.path.join(ref_model_dir, "inf_aver_k4.csv")
...
if 'fov' not in adata_st.obs.columns or 'cell_ID' not in adata_st.obs.columns:
    ...
    cell_metadata_file_name = "cell_metadata.csv"
    spatial_metadata_path = "/orange/kejun.huang/vasco.hinostroza/data/ibd/cell_metadata.csv"
...
nmf_output_dir = "/blue/kejun.huang/vasco.hinostroza/nicherunner/runs/ibd_cosmx_k4/output"
