...
reference_h5ad_path = "/path/to/reference.h5ad"
cosmx_h5ad_path = "/path/to/spatial.h5ad"
ref_model_dir = "/path/to/cell2location_models"
os.makedirs(ref_model_dir, exist_ok=True) # Ensure the directory exists
ref_model_path = os.path.join(ref_model_dir, "cell2location_reference_model_ibd_cosmx_k4")
...
inf_aver_csv_path = os.path.join(ref_model_dir, "inf_aver_ibd_cosmx_k4.csv")
...
if 'fov' not in adata_st.obs.columns or 'cell_ID' not in adata_st.obs.columns:
    ...
    spatial_metadata_path = os.path.join("/path/to/", cell_metadata_file_name)
...
nmf_output_dir = "/path/to/output_dir"
