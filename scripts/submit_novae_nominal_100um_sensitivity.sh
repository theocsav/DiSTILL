...
reject_conflict NOVAE_WORKERS "2"
...
# The pending sensitivity is deliberately limited to the group's remaining
# two CPUs; keep scheduler allocation and NOVAE worker concurrency identical.
export NOVAE_WORKERS="2"
export NOVAE_CPUS_PER_TASK="2"
