...
def validate_config(
    ...
    if mode == "fixed_k":
    ...
    elif mode in ("elbow_k", "poisson_redundancy_k", "poisson_cumulative_improvement_k"):
        ...
        errors.append("mode must be fixed_k, elbow_k, poisson_redundancy_k, or poisson_cumulative_improvement_k.")
