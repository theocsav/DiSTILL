...
#SBATCH --job-name=cell2location_IBD_3000_NMF-k5_500samples
#SBATCH --output=/blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/Outputs_3000epochs_500samples_NMF-k5/cell2location_IBD_3000epochs_500samples_NMF-k5.out
#SBATCH --error=/blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/Outputs_3000epochs_500samples_NMF-k5/cell2location_IBD_3000epochs_500samples_NMF-k5.err
#SBATCH --ntasks=1
...
# Run the R script
python /blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/IBD_3000epochs_500samples_NMF-k5.py
