...
#SBATCH --output=/blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/CosMx/Post-NMF_Analysis/MLP_51Features/IBD_MLP.out
#SBATCH --error=/blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/CosMx/Post-NMF_Analysis/MLP_51Features/IBD_MLP.err
#SBATCH --ntasks=1
...
# Run the R script
python /blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/IBD_MLP_51Features.py
