...
ref_model_path = os.path.join(ref_model_dir, "cell2location_reference_model_3000ep_500samp_NMF-k20")
...
output_dir = "/blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/Outputs_3000epochs_500samples_NMF-k20"
...
inf_aver_csv_path = os.path.join(ref_model_dir, "inf_aver_3000ep_500samp_NMF-k20.csv")
...
nmf_output_dir = "/blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/Outputs_3000epochs_500samples_NMF-k20"
