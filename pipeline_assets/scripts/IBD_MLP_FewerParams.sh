...
#SBATCH --job-name=IBD_MLP_FewerParams
#SBATCH --output=/blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/CosMx/Post-NMF_Analysis/MLP_FewerParams/IBD_MLP.out
#SBATCH --error=/blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/CosMx/Post-NMF_Analysis/MLP_FewerParams/IBD_MLP.err
#SBATCH --ntasks=1
...
echo "Running MLP_FewerParams classification on IBD data"

# Run the R script
python /blue/kejun.huang/tan.m/IBDCosMx_scRNAseq/IBD_MLP_FewerParams.py
